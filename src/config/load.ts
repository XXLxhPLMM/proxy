...
const ConfigMap: Record<'client_exclude_domain' | 'target_host' | 'target_port' | 'proxy_secret' | 'use_auth' | 'secret_type' | 'secret_key', any> = {
  client_exclude_domain: undefined, // 客户端排除域名列表
...
export { loadConfig, ConfigMap, setConfig, setClientExcludeDomain }
